...
//				new RepoConfig("China ISCAS Mirror", "https://mirror.iscas.ac.cn/git/ruyisdk/packages-index.git", 1 , true),
...
//				new RepoConfig("Custom", "", 0, false) };
	...
	public RepoConfig[] getRepoConfigs() {
		return new RepoConfig[] {
				...
				new RepoConfig("Custom", RuyiProperties.getCustomMirror(), 0, RuyiProperties.isCustomMirrorChecked()) };
	}
