...
public final class Constants {
	...
	public static final class Commands {
		public static final String VERSION_CHECK = "ruyi -V";
		public static final String TELEMETRY_UPLOAD = "ruyi telemetry upload";
		public static final String TELEMETRY_STATUS = "ruyi telemetry status";
		public static final String TELEMETRY_CONSENT = "ruyi telemetry consent";
		public static final String TELEMETRY_OPTOUT = "ruyi telemetry optout";
